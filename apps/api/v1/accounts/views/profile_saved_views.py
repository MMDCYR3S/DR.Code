...
@extend_schema_view(
    post=extend_schema(tags=['Profile'], summary='ذخیره/حذف نسخه در لیست علاقه‌مندی‌ها (Toggle)')
)   
...
@extend_schema_view(
    get=extend_schema(tags=['Profile'], summary='لیست نسخه‌های ذخیره‌شده توسط کاربر')
)
