    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="برای داروهایی که باید با هم ترکیب شوند، یک شناسه یکسان وارد کنید (مثلا: combo_1)",
                        max_length=100,
                        verbose_name="شناسه گروه ترکیبی",
                    ),
                ),
                (
                    "order",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="prescriptions",
                through="prescriptions.PrescriptionDrug",
                to="prescriptions.drug",
